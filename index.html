#   
Here is your updated code with the phone number completely removed from the contact section, leaving just your name, email, and address.  
You can copy this block and paste it directly into your index.html file on GitHub:  
```html  
<!DOCTYPE html>  
<html lang="en">  
<head>  
